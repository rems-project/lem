...
open lem_boolTheory basic_classesTheory optionTheory lem_functionTheory integerTheory intReduce lem_numTheory lemTheory;
...
val _ = Define `
 (SET_SPLIT dict_Basic_classes_Ord_a p s = ((SET_FILTER (
  dict_Basic_classes_Ord_a.isLess_method p) s), (SET_FILTER (
  dict_Basic_classes_Ord_a.isGreater_method p) s)))`;


(*val splitMember : forall 'a. Ord 'a, Eq 'a => 'a -> set 'a -> set 'a * bool * set 'a*)
val _ = Define `
 (splitMember dict_Basic_classes_Ord_a dict_Basic_classes_Eq_a p s = ((SET_FILTER (
...
val _ = Define `
 (deleteBy eq e s = ((SET_FILTER (\ e2 . (~ (eq e e2))) s)))`;
