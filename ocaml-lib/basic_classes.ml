...
(*let defaultCompare   = `***defaultCompare***`*)
(*let defaultLess      = `***defaultLess***`*)
(*let defaultLessEq    = `***defaultLessEq***`*)
(*let defaultGreater   = `***defaultGreater***`*)
(*let defaultGreaterEq = `***defaultGreaterEq***`*)
...
((match  dict_Basic_classes_Ord_b.compare_method a1 a2 with
    | (-1) -> (-1)
    | (1) -> (1)
    | (0) -> dict_Basic_classes_Ord_a.compare_method b1 b2
  ))
