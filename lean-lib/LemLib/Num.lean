...
/- 
 def  gen_pow_aux  {a : Type}   (mul  : a →  a →  a)  (a  : a)  (b  : a)  (e  : Nat)  : a := 
   match  e with  |  0 =>  a |  1 =>  mul  a  b | (  (e' + 2)) => ( let  e''  := (fun x y => x Instance_Num_NumDivision_nat./ y)  e  2;                     let  a'   := (if  (fun x y => x Instance_Basic_classes_Eq_nat.= y)  ((fun x y => x Instance_Num_NumRemainder_nat.mod y)  e  2)  0 then  a  else  mul  a  b);                     gen_pow_aux  mul  a'  (mul  b  b)  e'')
    -/
...
/- 
def  int32Abs  (i : LemInt32)  : LemInt32 :=  (if  Instance_Basic_classes_Ord_Num_int32.<=  0  i then  i  else  Instance_Num_NumNegate_Num_int32.~ i) -/
...
/- 
def  int64Abs  (i : LemInt64)  : LemInt64 :=  (if  Instance_Basic_classes_Ord_Num_int64.<=  0  i then  i  else  Instance_Num_NumNegate_Num_int64.~ i) -/
...
/- 
def  rationalFromFrac  (n : Int) (d : Int)  : LemRational :=  (fun x y => x Instance_Num_NumDivision_Num_rational./ y)  (unsupportedRationalFromInt  n)  (unsupportedRationalFromInt  d) -/
/- removed value specification -/
